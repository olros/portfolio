...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "TIHLDE",
    description:
      `Arbeidet frivillig i TIHLDE Index, linjeforeningens undergruppe med ansvar for nettsiden. Jobbet fullstack med React/Typescript frontend og Django/Python backend. Var nestleder i ett år.
